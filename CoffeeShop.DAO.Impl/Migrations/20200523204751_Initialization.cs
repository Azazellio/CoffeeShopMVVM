        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxCapacityWater = table.Column<int>(nullable: false),
                    MaxCapacityCoffee = table.Column<int>(nullable: false),
                    MaxCapacitySugar = table.Column<int>(nullable: false),
                    MaxCapacityMilk = table.Column<int>(nullable: false),
                    CurrentCapacityWater = table.Column<int>(nullable: false),
                    CurrentCapacityCoffee = table.Column<int>(nullable: false),
                    CurrentCapacitySugar = table.Column<int>(nullable: false),
                    CurrentCapacityMilk = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecipeDAOs_IngredientDAOs_IngredientDAOId",
                        column: x => x.IngredientDAOId,
                        principalTable: "IngredientDAOs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeDAOs_IngredientDAOId",
                table: "RecipeDAOs",
                column: "IngredientDAOId");
        }
